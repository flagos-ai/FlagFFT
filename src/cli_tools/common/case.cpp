...
cufftType cufft_type(FftApi api) {
    switch (api) {
        case FftApi::C2C: return CUFFT_C2C;
        case FftApi::Z2Z: return CUFFT_Z2Z;
        case FftApi::R2C: return CUFFT_R2C;
        case FftApi::D2Z: return CUFFT_D2Z;
        case FftApi::C2R: return CUFFT_C2R;
        case FftApi::Z2D: return CUFFT_Z2D;
    }
    return CUFFT_C2C;
}
