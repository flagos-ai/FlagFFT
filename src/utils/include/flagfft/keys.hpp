...
struct KernelKey {
  ...
  static KernelKey leaf_c2r(std::string target,
                            ...
                            std::vector<int64_t> generic_radices,
                            int64_t smem_size);
  static KernelKey leaf_bluestein(std::string target,
                                  std::string direction,
                                  std::string dtype,
                                  int64_t prime_n,
                                  int64_t length,
                                  ...
                                  std::vector<int64_t> generic_radices,
                                  int64_t smem_size);
  static KernelKey leaf_bluestein_prepare(std::string target,
                                          std::string direction,
                                          std::string dtype,
                                          int64_t prime_n,
                                          int64_t length,
                                          ...
                                          std::vector<int64_t> generic_radices,
                                          int64_t smem_size);
  static KernelKey leaf_bluestein_finish(std::string target,
                                         std::string direction,
                                         std::string dtype,
                                         int64_t prime_n,
                                         int64_t length,
