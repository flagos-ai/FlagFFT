...
def set_ix_real_single_pack(enabled: bool):
    return _IX_REAL_SINGLE_PACK.set(bool(enabled))


def ix_real_single_pack_enabled() -> bool:
    return _IX_REAL_SINGLE_PACK.get()
