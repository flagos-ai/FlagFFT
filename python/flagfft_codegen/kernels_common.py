...
def _non_nvidia_backend_active() -> bool:
    """Whether the installed Triton is a non-NVIDIA port (MThreads/PPU/IX/NPU).
    ...
    these backends.
    """
    return (_npu_backend_active() or _mthreads_backend_active()
            or _ppu_backend_active() or _ix_backend_active())
