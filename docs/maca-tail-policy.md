...
All other combinations retain their existing path. In particular no automatic
real 997/1009/1M, FP64 328050, mixed-exchange, batch or multidimensional changes
are included. A 2D/3D axis cannot qualify merely by having rank-1/batch-1 shape.
