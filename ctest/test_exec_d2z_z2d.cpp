...
TEST(D2Z_Z2D, Roundtrip1D) {
  ...
  auto* d_in = static_cast<flagfftDoubleReal*>(allocate_device(N * sizeof(flagfftDoubleReal)));
  auto* d_mid = static_cast<flagfftDoubleComplex*>(allocate_device(C_OUT * sizeof(flagfftDoubleComplex)));
  auto* d_out = static_cast<flagfftDoubleReal*>(allocate_device(N * sizeof(flagfftDoubleReal)));
...
TEST(D2Z, ForwardVsReference) {
  ...
  auto h_in = random_double_real(N);
  auto* d_in = static_cast<flagfftDoubleReal*>(allocate_device(N * sizeof(flagfftDoubleReal)));
  auto* d_out = static_cast<flagfftDoubleComplex*>(allocate_device(C_OUT * sizeof(flagfftDoubleComplex)));
  auto* d_ref = static_cast<flagfftDoubleComplex*>(allocate_device(C_OUT * sizeof(flagfftDoubleComplex)));
  ASSERT_NE(d_in, nullptr);
